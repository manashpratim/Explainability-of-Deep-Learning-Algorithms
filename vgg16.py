...
class vgg16:
    ...
    def convlayers(self):
        ...
        with tf.name_scope('conv1_1') as scope:
            kernel = tf.Variable(tf.random.truncated_normal([3, 3, 3, 64],
                                                            dtype=tf.float32,
                                                            stddev=1e-1),
                                 name='weights')
        ...
        with tf.name_scope('conv1_2') as scope:
            kernel = tf.Variable(tf.random.truncated_normal([3, 3, 64, 64],
                                                            dtype=tf.float32,
                                                            stddev=1e-1),
                                 name='weights')
        ...
        with tf.name_scope('conv2_1') as scope:
            kernel = tf.Variable(tf.random.truncated_normal([3, 3, 64, 128],
                                                            dtype=tf.float32,
                                                            stddev=1e-1),
                                 name='weights')
        ...
        with tf.name_scope('conv2_2') as scope:
            kernel = tf.Variable(tf.random.truncated_normal([3, 3, 128, 128],
                                                            dtype=tf.float32,
                                                            stddev=1e-1),
                                 name='weights')
        ...
        with tf.name_scope('conv3_1') as scope:
            kernel = tf.Variable(tf.random.truncated_normal([3, 3, 128, 256],
                                                            dtype=tf.float32,
                                                            stddev=1e-1),
                                 name='weights')
        ...
        with tf.name_scope('conv4_1') as scope:
            kernel = tf.Variable(tf.random.truncated_normal([3, 3, 256, 512],
                                                            dtype=tf.float32,
                                                            stddev=1e-1),
                                 name='weights')
        ...
        with tf.name_scope('conv4_2') as scope:
            kernel = tf.Variable(tf.random.truncated_normal([3, 3, 512, 512],
                                                            dtype=tf.float32,
                                                            stddev=1e-1),
                                 name='weights')
    ...
    def load_weights(self, weight_file, sess):
        if weight_file == 'imagenet':
            if not Path('vgg16_weights.npz').is_file():
                print('Downloading pretrained weights...')
                url = 'https://www.cs.toronto.edu/~frossard/vgg16/vgg16_weights.npz'
                urllib.request.urlretrieve(url, './vgg16_weights.npz')
...
if __name__ == '__main__':
    from hw3_utils import class_names
    from hw3_utils import img_to_array, load_img
    ...
    imgs = [img_to_array(load_img(i, target_size=(224, 224))) for i in images]

    probs = sess.run(vgg.probs, feed_dict={vgg.imgs: imgs})
